...
export const guides: Guide[] = [
  ...
  {
    title: 'Nickel Alloys Preparation',
    slug: 'nickel-alloys-preparation',
    description: 'Comprehensive guide for preparing nickel and nickel-based superalloys. Learn techniques for handling high-temperature alloys and revealing complex microstructures.',
    category: 'Material-Specific',
