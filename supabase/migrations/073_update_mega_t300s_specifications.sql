-- ============================================================================
-- UPDATE MEGA-T300S WITH ABRASIVE SECTIONING SPECIFICATIONS
-- ============================================================================
-- Based on the old website specifications provided
-- This is a manual abrasive sectioning machine
-- ============================================================================

-- Ensure equipment_sectioning record exists for MEGA-T300S
INSERT INTO equipment_sectioning (equipment_id)
SELECT id FROM equipment WHERE item_id = 'MEGA-T300S'
...
SET
  ...
  -- Table Feed: Manual
  -- Y Pulse Feed: Manual
  feed_rate_mm_per_min = 'Y-axis: 7-inch (180 mm) range; All feeds manual',
  ...
  motor_power_watts = '4.5 kW (5.8 hp) Variable Speed Servo Motor',
