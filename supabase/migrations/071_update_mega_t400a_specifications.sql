-- ============================================================================
-- UPDATE MEGA-T400A WITH ABRASIVE SECTIONING SPECIFICATIONS
-- ============================================================================
-- Based on the old website specifications provided
-- This is an automated abrasive sectioning machine
-- ============================================================================

-- Ensure equipment_sectioning record exists for MEGA-T400A
INSERT INTO equipment_sectioning (equipment_id)
SELECT id FROM equipment WHERE item_id = 'MEGA-T400A'
...
SET
  ...
  -- Y Pulse Feed: Auto
  feed_rate_mm_per_min = 'Y-axis: 0.04 to 0.20-inch/second (1-10 mm/second); X-axis (Optional): 0.04 to 0.07-inch/second (1-2 mm/second)',
