-- ============================================================================
-- UPDATE FEMTO-1500S WITH SEMI-AUTOMATED POLISHING HEAD SPECIFICATIONS
-- ============================================================================
-- Based on the technical specifications provided:
-- Application of Force: Individual pistons (1-6 samples), Central force (3-6 samples)
-- Head Speed: 0-300 rpm (variable)
-- Motor: 0.54 hp (400 W) dynamic torque servo motor
-- Compatibility: NANO-1000S / NANO-2000S polishers
-- Electrical Specifications: 110V or 220V 50/60 Hz
-- ============================================================================

-- Ensure equipment_grinding_polishing record exists for FEMTO-1500S
INSERT INTO equipment_grinding_polishing (equipment_id)
SELECT id FROM equipment WHERE item_id = 'FEMTO-1500S'
...
SET
  ...
  force_range_per_sample_n = 'Individual pistons (1-6 samples) or Central force (3-6 samples)',
  ...
  -- Compatibility
  compatible_base_models = 'NANO-1000S / NANO-2000S',
  ...
  optional_accessories = '[
    ...
    },
    {
      ...
      "description": "Dual mode: Individual pistons (1-6 samples) with independent control, or Central force (3-6 samples)"
    }
  ]'::JSONB,
