-- ============================================================================
-- UPDATE TP-7500S WITH COMPRESSION MOUNTING SPECIFICATIONS
-- ============================================================================
...
-- Force: Hydraulic
-- Maximum Force: 32 MPa (4500 psi)
-- Heater Specification: 1000 Watts (110V 15 amp), 2000 Watts (220V 10 amp)
...
-- Ensure equipment_mounting record exists for TP-7500S
INSERT INTO equipment_mounting (equipment_id)
SELECT id FROM equipment WHERE item_id = 'TP-7500S'
...
SET
  ...
  force_type = 'Hydraulic',
  max_force_mpa = '32 MPa',
  max_force_psi = '4500 psi',
  
  -- Heater specifications
  heater_specification = '1000 Watts (110V 15 amp), 2000 Watts (220V 10 amp)',
