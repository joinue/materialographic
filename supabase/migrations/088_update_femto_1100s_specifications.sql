-- ============================================================================
-- UPDATE FEMTO-1100S WITH SEMI-AUTOMATED POLISHING HEAD SPECIFICATIONS
-- ============================================================================
...
-- Ensure equipment_grinding_polishing record exists for FEMTO-1100S
INSERT INTO equipment_grinding_polishing (equipment_id)
SELECT id FROM equipment WHERE item_id = 'FEMTO-1100S'
