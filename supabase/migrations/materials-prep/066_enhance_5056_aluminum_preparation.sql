-- Enhance preparation procedures for 5056 Aluminum
...
-- ============================================================================
-- UPDATE 5056 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '5056 Aluminum is a very soft (65 HB) non-heat-treatable aluminum-magnesium alloy (Al-5.2Mg-0.12Cr-0.1Mn) with an alpha aluminum solid solution microstructure. The high magnesium content (5.2%) provides excellent corrosion resistance, especially in marine environments. The very low hardness requires extremely careful preparation to avoid smearing, orange peel, and excessive relief. Use very low to low pressure throughout all preparation steps to prevent deformation of the very soft aluminum matrix. Sharp, fresh abrasives are essential to minimize smearing. The magnesium (5.2%), chromium (0.12%), and manganese (0.1%) content are in solid solution, so the material will respond well to standard aluminum etchants. The material exhibits work hardening, so strain-hardened conditions may show different microstructural features than annealed material. Monitor for smearing and relief during grinding and polishing - reduce pressure immediately if any deformation is observed. Commonly used in marine hardware, wire, and rivets due to excellent corrosion resistance, especially in seawater environments.'
WHERE (slug = '5056-aluminum' OR name = '5056 Aluminum')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5056 Aluminum not found. Please verify the material exists in the database with slug "5056-aluminum" or name "5056 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5056 Aluminum preparation procedures';
