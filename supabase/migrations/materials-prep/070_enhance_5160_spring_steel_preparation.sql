-- Enhance preparation procedures for 5160 Spring Steel
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5160 Spring Steel not found. Please verify the material exists in the database with slug "5160-spring-steel" or name "5160 Spring Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5160 Spring Steel preparation procedures';
