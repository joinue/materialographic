-- Enhance preparation procedures for 347 Stainless Steel
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 347 Stainless Steel not found. Please verify the material exists in the database with slug "347-stainless-steel" or name "347 Stainless Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 347 Stainless Steel preparation procedures';
