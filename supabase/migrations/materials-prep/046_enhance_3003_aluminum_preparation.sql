-- Enhance preparation procedures for 3003 Aluminum
...
-- ============================================================================
-- UPDATE 3003 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '3003 Aluminum is a very soft (28 HB) non-heat-treatable aluminum-manganese alloy (Al-1.2Mn-0.12Cu) with an alpha aluminum solid solution microstructure. The extreme softness requires very careful preparation to avoid smearing, orange peel, and excessive relief. Use low pressure throughout all preparation steps to prevent deformation of the soft aluminum matrix. Sharp, fresh abrasives are essential to minimize smearing. The manganese content is low and in solid solution, so the material will respond well to standard aluminum etchants. Monitor for smearing and relief during grinding and polishing - reduce pressure if any deformation is observed.'
WHERE (slug = '3003-aluminum' OR name = '3003 Aluminum')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 3003 Aluminum not found. Please verify the material exists in the database with slug "3003-aluminum" or name "3003 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 3003 Aluminum preparation procedures';
