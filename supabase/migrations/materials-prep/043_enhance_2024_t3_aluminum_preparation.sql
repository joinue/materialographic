-- Enhance preparation procedures for 2024-T3 Aluminum
...
-- ============================================================================
-- UPDATE 2024-T3 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '2024-T3 Aluminum is a soft (120 HB) high-strength aluminum-copper alloy with Cu-Mg precipitates in T3 temper (solution treated and naturally aged). Used extensively in aircraft skins and wing structures. The T3 temper means the material has been naturally aged at room temperature, which may result in slightly different precipitation characteristics compared to artificially aged (T6) material. The softness requires careful preparation to avoid smearing and deformation. The copper and magnesium content means it will respond well to standard aluminum etchants and will show clear grain structure and precipitates. Use low to moderate pressure throughout grinding and polishing to prevent smearing of the soft aluminum matrix. Monitor for relief around precipitates during polishing.'
WHERE (id = 'b4d6589d-1a75-454a-bb7d-0e6c21ffcc33'::uuid
   OR (slug = '2024-t3-aluminum' AND name = '2024-T3 Aluminum'))
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 2024-T3 Aluminum not found (tried ID: b4d6589d-1a75-454a-bb7d-0e6c21ffcc33, slug: 2024-t3-aluminum)';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 2024-T3 Aluminum preparation procedures';
