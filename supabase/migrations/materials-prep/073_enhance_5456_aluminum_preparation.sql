-- Enhance preparation procedures for 5456 Aluminum
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5456 Aluminum not found. Please verify the material exists in the database with slug "5456-aluminum" or name "5456 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5456 Aluminum preparation procedures';
