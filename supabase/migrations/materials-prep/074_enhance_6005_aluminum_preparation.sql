-- Enhance preparation procedures for 6005 Aluminum
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 6005 Aluminum not found. Please verify the material exists in the database with slug "6005-aluminum" or name "6005 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 6005 Aluminum preparation procedures';
