-- Enhance preparation procedures for 3004 Aluminum
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 3004 Aluminum not found. Please verify the material exists in the database with slug "3004-aluminum" or name "3004 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 3004 Aluminum preparation procedures';
