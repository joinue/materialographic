-- Enhance preparation procedures for 5052 Aluminum
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5052 Aluminum not found. Please verify the material exists in the database with slug "5052-aluminum" or name "5052 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5052 Aluminum preparation procedures';
