-- Enhance preparation procedures for 2024 Aluminum
...
-- ============================================================================
-- UPDATE 2024 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '2024 Aluminum is a soft (120 HB) high-strength aluminum-copper alloy with Cu-Mg precipitates. Widely used in aircraft structures, rivets, and wing skins due to excellent fatigue resistance. The softness requires careful preparation to avoid smearing and deformation, though it is slightly harder than some other aluminum alloys. The copper and magnesium content means it will respond well to standard aluminum etchants and will show clear grain structure and precipitates. Use low to moderate pressure throughout grinding and polishing to prevent smearing of the soft aluminum matrix. Monitor for relief around precipitates during polishing.'
WHERE (id = '6ac2a869-402a-421d-b26a-f454bbc3fe59'::uuid
   OR (slug = '2024-aluminum' AND name = '2024 Aluminum'))
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 2024 Aluminum not found (tried ID: 6ac2a869-402a-421d-b26a-f454bbc3fe59, slug: 2024-aluminum)';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 2024 Aluminum preparation procedures';
