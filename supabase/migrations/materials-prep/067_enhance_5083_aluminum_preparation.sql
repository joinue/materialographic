-- Enhance preparation procedures for 5083 Aluminum
...
-- ============================================================================
-- UPDATE 5083 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '5083 Aluminum is a soft (75 HB) non-heat-treatable aluminum-magnesium-manganese alloy (Al-4.5Mg-0.7Mn-0.15Cr) with an alpha aluminum solid solution microstructure. High-strength aluminum-magnesium alloy with excellent corrosion resistance and weldability, commonly used in marine, cryogenic, and pressure vessel applications. The softness requires careful preparation to avoid smearing, orange peel, and excessive relief. Use low to moderate pressure throughout all preparation steps to prevent deformation of the soft aluminum matrix. Sharp, fresh abrasives are essential to minimize smearing. The magnesium (4.5%), manganese (0.7%), and chromium (0.15%) content are in solid solution, so the material will respond well to standard aluminum etchants. The material exhibits work hardening, so strain-hardened conditions may show different microstructural features than annealed material. Monitor for smearing and relief during grinding and polishing - reduce pressure if any deformation is observed. Commonly used in ship hulls, cryogenic tanks, and pressure vessels due to excellent corrosion resistance and weldability.'
WHERE (slug = '5083-aluminum' OR name = '5083 Aluminum')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5083 Aluminum not found. Please verify the material exists in the database with slug "5083-aluminum" or name "5083 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5083 Aluminum preparation procedures';
