-- Enhance preparation procedures for 420 Stainless Steel
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 420 Stainless Steel not found. Please verify the material exists in the database with slug "420-stainless-steel" or name "420 Stainless Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 420 Stainless Steel preparation procedures';
