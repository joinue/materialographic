-- Enhance preparation procedures for 5086 Aluminum
...
-- ============================================================================
-- UPDATE 5086 ALUMINUM PREPARATION PROCEDURES
-- ============================================================================

-- Add comprehensive preparation notes
UPDATE materials
SET preparation_notes = '5086 Aluminum is a soft (70 HB) non-heat-treatable aluminum-magnesium-manganese alloy (Al-4.0Mg-0.4Mn-0.15Cr) with an alpha aluminum solid solution microstructure. Aluminum-magnesium alloy with excellent corrosion resistance and weldability, commonly used in marine, pressure vessel, and cryogenic applications. The softness requires careful preparation to avoid smearing, orange peel, and excessive relief. Use low to moderate pressure throughout all preparation steps to prevent deformation of the soft aluminum matrix. Sharp, fresh abrasives are essential to minimize smearing. The magnesium (4.0%), manganese (0.4%), and chromium (0.15%) content are in solid solution, so the material will respond well to standard aluminum etchants. The material exhibits work hardening, so strain-hardened conditions may show different microstructural features than annealed material. Monitor for smearing and relief during grinding and polishing - reduce pressure if any deformation is observed. Commonly used in marine structures, pressure vessels, and cryogenic tanks due to excellent corrosion resistance and weldability.'
WHERE (slug = '5086-aluminum' OR name = '5086 Aluminum')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 5086 Aluminum not found. Please verify the material exists in the database with slug "5086-aluminum" or name "5086 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 5086 Aluminum preparation procedures';
