-- Enhance preparation procedures for 52100 Bearing Steel
...
UPDATE materials
SET grinding_notes = 'The medium hardness (197 HB) of 52100 Bearing Steel allows for standard grinding procedures. Use standard SiC grinding papers with adequate water lubrication. Disc speed: 200-300 RPM. Apply moderate pressure (25-35 N per 30 mm sample) - the medium-hard material can tolerate reasonable pressure. Use sharp, fresh grinding papers to minimize deformation. The chromium carbides are harder than the matrix and may require longer grinding times to remove scratches around them.<br /><br /><strong>Grinding sequence:</strong><ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>120 grit:</strong> Remove sectioning damage (30-60 seconds). Use moderate pressure to remove heat-affected zone.</li><li><strong>240 grit:</strong> Remove previous scratches (30-60 seconds). Ensure complete scratch removal. The chromium carbides may require longer times.</li><li><strong>320 grit:</strong> Further refinement (30-60 seconds). Continue scratch removal. Monitor for relief around carbides.</li><li><strong>400 grit:</strong> Refinement (30-60 seconds). Prepare for polishing. Ensure scratches are removed from around carbides.</li><li><strong>600 grit:</strong> Final grinding step (30-60 seconds). Ensure all scratches are removed before polishing. The chromium carbides should be well-integrated with the matrix.</li></ul>Always rotate the specimen holder 90° between steps to ensure complete scratch removal. Use complementary rotation (platen and holder same direction, different speeds) rather than contra-rotation to minimize deformation. Adequate water lubrication is critical. Monitor for relief around chromium carbides - excessive relief can lead to pullout during polishing.'
WHERE (slug = '52100-bearing-steel' OR name = '52100 Bearing Steel')
...
UPDATE materials
SET etching_notes = '52100 Bearing Steel responds well to standard alloy steel etchants. The tempered martensite structure with chromium carbides will reveal clearly with appropriate etchants. The high carbon content (1.0%) and chromium addition may require slightly longer etching times than lower carbon steels. Two primary etchants are recommended:<br /><br /><strong>2% Nital (Chemical Etching)</strong> - Primary choice for bearing steels:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 2ml HNO₃ (concentrated), 98ml ethanol</li><li><strong>Preparation:</strong> Add nitric acid to ethanol slowly with stirring. Prepare fresh for best results. Solution is stable for several days if stored properly.</li><li><strong>Application:</strong> Immerse sample or swab for 5-15 seconds. Standard etchant for alloy steels. The high carbon content and chromium addition may require slightly longer etching times than lower carbon steels.</li><li><strong>Reveals:</strong> Tempered martensite structure, prior austenite grain boundaries, and chromium carbides clearly. Excellent for general microstructure examination. Good contrast for tempered martensite structure. The chromium carbides will appear as bright or dark particles depending on etching time.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air or warm air to avoid staining.</li><li><strong>Note:</strong> Prepare fresh when needed. Shelf life: several days. Use in fume hood. The high carbon content may require slightly longer etching times.</li></ul><strong>4% Picral (Chemical Etching)</strong> - For revealing carbides and fine structure:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 4g picric acid, 100ml ethanol</li><li><strong>Preparation:</strong> Dissolve picric acid in ethanol with stirring. Prepare fresh for best results. Solution is stable for several weeks if stored properly.</li><li><strong>Application:</strong> Immerse sample or swab for 10-60 seconds. Excellent for revealing carbides without attacking the matrix. Particularly useful when examining carbide distribution in tempered martensite. The high carbon content means more carbides will be present.</li><li><strong>Reveals:</strong> Chromium carbides clearly with excellent contrast. Less aggressive on the matrix than nital. Good for revealing fine carbide distribution in tempered martensite. The carbides will appear as distinct particles in the etched matrix.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air.</li><li><strong>Note:</strong> Prepare fresh when needed. Shelf life: several weeks if stored properly. Use in fume hood. Picric acid is explosive when dry - keep moist and handle with care.</li></ul><strong>Etching Strategy:</strong><ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li>Start with 2% nital for general microstructure examination - it provides good contrast and reveals tempered martensite structure and carbides clearly</li><li>Use 4% picral if you need to examine carbide distribution in detail or when nital is too aggressive</li><li>Etching time may vary with tempering condition - higher tempering temperatures result in coarser carbides and different etching response</li><li>The high carbon content (1.0%) and chromium addition provide excellent hardenability - ensure material is properly quenched and tempered</li><li>Always clean and degrease before etching</li><li>Use short initial etch times (a few seconds), check under the microscope, repeat if needed</li><li>Check etching progress frequently - over-etching can obscure fine details</li><li>For bearing applications (ball bearings, roller bearings, bearing races), ensure proper surface preparation to reveal carbide distribution and any service-related changes or wear</li><li>The chromium carbides are critical for wear resistance - ensure proper etching to reveal their distribution and morphology</li><li>The tempered martensite structure should reveal prior austenite grain boundaries with proper etching</li><li>Carbides may be present depending on tempering temperature - higher tempering temperatures result in more and coarser carbides</li><li>The high carbon content means more carbides will be present compared to lower carbon steels</li><li>Monitor for carbide pullout during etching - if carbides are pulled out, the polishing may have been too aggressive or relief was excessive</li></ul><strong>Safety:</strong> Both etchants require proper PPE and fume hood. Nital produces toxic fumes. Picral contains picric acid which is explosive when dry - keep moist and handle with extreme care.'
WHERE (slug = '52100-bearing-steel' OR name = '52100 Bearing Steel')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 52100 Bearing Steel not found. Please verify the material exists in the database with slug "52100-bearing-steel" or name "52100 Bearing Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 52100 Bearing Steel preparation procedures';
