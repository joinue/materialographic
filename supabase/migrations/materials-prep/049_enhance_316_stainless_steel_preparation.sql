-- Enhance preparation procedures for 316 Stainless Steel
...
-- Fix polishing sequence: Update to full sequence for soft to medium-hard stainless steel
-- Standard for soft to medium-hard stainless steel should be: 6μm, 3μm, 1μm, 0.05μm colloidal silica (4 steps)
UPDATE materials
...
UPDATE materials
SET etching_notes = '316 Stainless Steel responds well to standard austenitic stainless steel etchants. The high chromium, nickel, and molybdenum content can make the material more difficult to etch than carbon steels, but several effective etchants are available. The molybdenum addition may require slightly longer etching times than 304 stainless steel. Three primary etchants are recommended:<br /><br /><strong>Glyceregia (Chemical Etching)</strong> - Primary choice for general microstructure:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 10ml glycerol, 15ml HCl, 5ml HNO₃</li><li><strong>Preparation:</strong> Add acids to glycerol slowly with stirring. Prepare fresh for best results. The glycerol moderates the reaction rate.</li><li><strong>Application:</strong> Immerse sample or swab for 15-40 seconds. The molybdenum content may require slightly longer etching times than 304. Classic general-purpose micro-etchant for austenitic stainless steels. Provides good grain boundary contrast.</li><li><strong>Reveals:</strong> Grain boundaries, grain structure, and twin boundaries clearly. Excellent for general microstructure examination. Good contrast for austenitic structure.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air or warm air to avoid staining.</li><li><strong>Note:</strong> Prepare fresh when needed. Shelf life: several hours. Use in fume hood. The glycerol moderates the reaction - check progress frequently, especially for molybdenum-bearing grades.</li></ul><strong>10% Oxalic Acid (Electrolytic)</strong> - For revealing grain boundaries and structure:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 10g oxalic acid dihydrate (COOH)₂·2H₂O in 100ml distilled water</li><li><strong>Preparation:</strong> Dissolve oxalic acid in water. Solution is stable for several months.</li><li><strong>Application:</strong> Use as electrolyte with stainless steel cathode. Sample is anode. Apply 6V DC at 0.1 A/cm² current density for 30-90 seconds. The molybdenum content may require slightly longer etching times than 304.</li><li><strong>Reveals:</strong> Grain boundaries, twin boundaries, and grain structure. Less aggressive than chemical etchants, good for revealing fine microstructural details. Provides consistent results. Particularly useful for molybdenum-bearing stainless steels.</li><li><strong>Rinse:</strong> Immediately with water after etching. Dry with compressed air.</li><li><strong>Note:</strong> Ensure good electrical contact. If no etching occurs, check connections and increase voltage slightly. Electrolytic etching provides more control than chemical etching and is often preferred for 316 due to the molybdenum content.</li></ul><strong>Aqua Regia (Chemical Etching)</strong> - For aggressive etching when other methods fail:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 3 parts HCl, 1 part HNO₃ (by volume)</li><li><strong>Preparation:</strong> Mix acids just before use. Prepare fresh - solution is unstable and loses effectiveness quickly.</li><li><strong>Application:</strong> Immerse sample or swab for 5-20 seconds. Very aggressive etchant - use with caution. Good for difficult-to-etch samples or when other etchants fail. The molybdenum content may make 316 slightly more resistant to etching than 304.</li><li><strong>Reveals:</strong> Grain boundaries and structure. Very aggressive - can over-etch quickly. Use for samples that resist other etchants.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air.</li><li><strong>Note:</strong> Prepare fresh immediately before use. Shelf life: minutes. Use in fume hood with excellent ventilation. Very corrosive - handle with extreme care.</li></ul><strong>Etching Strategy:</strong><ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li>Start with Glyceregia for general microstructure examination - it provides good contrast and reveals grain boundaries clearly. May require slightly longer times than 304 due to molybdenum content</li><li>Use electrolytic 10% oxalic acid for more controlled etching or when chemical etchants are too aggressive - often preferred for 316 due to better control</li><li>Use Aqua Regia only when other etchants fail or for very difficult-to-etch samples</li><li>Etching time may vary with heat treatment condition - solution-annealed material may etch differently than cold-worked material</li><li>Always clean and degrease before etching</li><li>Use short initial etch times (a few seconds), check under the microscope, repeat if needed</li><li>Check etching progress frequently - over-etching can obscure fine details</li><li>For marine and chemical processing applications, ensure proper surface preparation to reveal any pitting corrosion, crevice corrosion, or sensitization</li><li>For medical device applications, ensure proper surface preparation to reveal any surface contamination or defects</li><li>If delta ferrite is present, it may appear as dark islands in the austenitic matrix</li><li>The molybdenum content may make 316 slightly more resistant to etching than 304 - be prepared to use slightly longer etching times</li></ul><strong>Safety:</strong> All etchants are highly corrosive and produce toxic fumes – full PPE (gloves, safety glasses, lab coat), proper fume hood, and appropriate safety measures are mandatory. Aqua Regia is particularly dangerous - use with extreme caution.'
WHERE (slug = '316-stainless-steel' OR name = '316 Stainless Steel')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 316 Stainless Steel not found. Please verify the material exists in the database with slug "316-stainless-steel" or name "316 Stainless Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 316 Stainless Steel preparation procedures';
