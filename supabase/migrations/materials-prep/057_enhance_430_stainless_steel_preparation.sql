-- Enhance preparation procedures for 430 Stainless Steel
...
UPDATE materials
SET etching_notes = '430 Stainless Steel responds well to standard ferritic stainless steel etchants. The ferritic structure will reveal grain boundaries clearly with appropriate etchants. Two primary etchants are recommended:<br /><br /><strong>Vilella''s Reagent (Chemical Etching)</strong> - Primary choice for general microstructure:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 1g picric acid, 5ml HCl, 100ml ethanol</li><li><strong>Preparation:</strong> Dissolve picric acid in ethanol, then add HCl. Prepare fresh for best results. Solution is stable for several weeks if stored properly.</li><li><strong>Application:</strong> Immerse sample or swab for 10-20 seconds. Classic general-purpose micro-etchant for ferritic and martensitic stainless steels. Provides good grain boundary contrast.</li><li><strong>Reveals:</strong> Grain boundaries and ferritic grain structure clearly. Excellent for general microstructure examination. Good contrast for ferritic structure. May reveal carbides if present.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air or warm air to avoid staining.</li><li><strong>Note:</strong> Prepare fresh when needed. Shelf life: several weeks if stored properly. Use in fume hood. Picric acid is explosive when dry - keep moist and handle with care.</li></ul><strong>2% Nital (Chemical Etching)</strong> - Alternative etchant for ferritic stainless steels:<ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li><strong>Composition:</strong> 2ml HNO₃ (concentrated), 98ml ethanol</li><li><strong>Preparation:</strong> Add nitric acid to ethanol slowly with stirring. Prepare fresh for best results. Solution is stable for several days.</li><li><strong>Application:</strong> Immerse sample or swab for 10-30 seconds. Standard etchant for ferritic and martensitic stainless steels. Provides good contrast for ferritic grain structure.</li><li><strong>Reveals:</strong> Grain boundaries and ferritic grain structure. Good for revealing grain size and any carbides present.</li><li><strong>Rinse:</strong> Immediately with water, then ethanol. Dry with compressed air.</li><li><strong>Note:</strong> Prepare fresh when needed. Shelf life: several days. Use in fume hood. Less aggressive than Vilella''s reagent, good for fine microstructural details.</li></ul><strong>Etching Strategy:</strong><ul style="margin-top: 0.5rem; margin-bottom: 0.5rem; padding-left: 1.5rem;"><li>Start with Vilella''s reagent for general microstructure examination - it provides good contrast and reveals ferritic grain boundaries clearly</li><li>Use 2% Nital if Vilella''s is too aggressive or for revealing fine microstructural details</li><li>Etching time may vary with annealing condition - annealed material may etch differently than cold-worked material</li><li>The ferritic structure is stable and will not transform to martensite, so etching behavior is more consistent than martensitic grades</li><li>Always clean and degrease before etching</li><li>Use short initial etch times (a few seconds), check under the microscope, repeat if needed</li><li>Check etching progress frequently - over-etching can obscure fine details</li><li>For decorative and automotive applications, ensure proper surface preparation to reveal any microstructural changes from forming or service</li><li>Grain size may vary depending on annealing temperature - higher annealing temperatures result in larger grains</li></ul><strong>Safety:</strong> Both etchants require proper PPE and fume hood. Vilella''s reagent contains picric acid which is explosive when dry - keep moist and handle with extreme care. Nital produces toxic fumes.'
WHERE (slug = '430-stainless-steel' OR name = '430 Stainless Steel')
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 430 Stainless Steel not found. Please verify the material exists in the database with slug "430-stainless-steel" or name "430 Stainless Steel"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 430 Stainless Steel preparation procedures';
