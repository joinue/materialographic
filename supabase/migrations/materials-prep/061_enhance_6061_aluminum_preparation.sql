-- Enhance preparation procedures for 6061 Aluminum
...
BEGIN
  ...
  IF v_material_name IS NULL THEN
    RAISE EXCEPTION 'Material 6061 Aluminum not found. Please verify the material exists in the database with slug "6061-aluminum" or name "6061 Aluminum"';
  END IF;
  ...
  RAISE NOTICE 'Successfully updated 6061 Aluminum preparation procedures';
